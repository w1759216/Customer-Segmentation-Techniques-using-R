...
my_data$Spending.Score..1.100.[69] <- mean(my_data$Spending.Score..1.100., na.rm = TRUE)
my_data$Age[168] <- mean(my_data$Age, na.rm = TRUE)
my_data$Age[199] <- mean(my_data$Age, na.rm = TRUE)
sapply(my_data, function(x) which(is.na(x)))
